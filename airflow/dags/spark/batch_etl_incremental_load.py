...
def batch_etl(processor):
    ...
    incremental_fact_listen = listen_events_df["listen_events_df"].join(dim_time, (listen_events_df["listen_events_df"]["hour"] == dim_time["hour"]) & (listen_events_df["listen_events_df"]["minute"] == dim_time["minute"]) & (listen_events_df["listen_events_df"]["second"] == dim_time["second"]), "inner") \
    ...
    incremental_fact_auth = auth_events_df["auth_events_df"].join(dim_time, (auth_events_df["auth_events_df"]["hour"] == dim_time["hour"]) & (auth_events_df["auth_events_df"]["minute"] == dim_time["minute"]) & (auth_events_df["auth_events_df"]["second"] == dim_time["second"]), "inner") \
    ...
    incremental_fact_page_view = page_view_events_df["page_view_events_df"].join(dim_time, (page_view_events_df["page_view_events_df"]["hour"] == dim_time["hour"]) & (page_view_events_df["page_view_events_df"]["minute"] == dim_time["minute"]) & (page_view_events_df["page_view_events_df"]["second"] == dim_time["second"]), "inner") \
    ...
    # Load data to hdfs
    processor.load_to_hdfs(incremental_fact_listen, "fact_listen", "append")
    processor.load_to_hdfs(incremental_fact_auth, "fact_auth", "append")
    processor.load_to_hdfs(incremental_fact_page_view, "fact_page_view", "append")
